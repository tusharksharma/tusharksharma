...
import { sauces, breakfasts, desserts, quickLunches, bases, powerups } from "../src/data/cookbook.js";

const allCookbook = [...sauces, ...breakfasts, ...desserts, ...quickLunches, ...bases, ...powerups];
