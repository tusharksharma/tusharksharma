...
import { sauces, breakfasts, desserts, quickLunches, bases, powerups, snackBoxes } from "../src/data/cookbook.js";

const allCookbook = [...sauces, ...breakfasts, ...desserts, ...quickLunches, ...bases, ...powerups, ...snackBoxes];
