...
const coversNextNight = (d) => Boolean(d && (d.reheats || d.leftoverNote));
...
function LeftoverDay({ day, meal, visible, chain, note }) {
  ...
  if (note) {
    return (
      <div className="flex items-center gap-3 px-4 py-3 bg-neutral-900/30 border border-amber-500/20 rounded-lg">
        ...
        <span className="text-[10px] bg-amber-900/30 text-amber-500 px-2 py-0.5 rounded-full ml-auto flex-shrink-0">Second night</span>
      </div>
    );
  }
  if (chain) {
      ...
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="relative" id="timeline">
          ...
          <div className="space-y-2 relative">
            ...
            <LeftoverDay day="Tuesday" meal={leftoverMsgs.tue} visible={leftovers && enabledMeals.Mon && coversNextNight(currentWeek.cookDays[0])} chain={currentWeek.cookDays[0].chainTo} note={currentWeek.cookDays[0].leftoverNote} />
            ...
            <LeftoverDay day="Thursday" meal={leftoverMsgs.thu} visible={leftovers && enabledMeals.Wed && coversNextNight(currentWeek.cookDays[1])} chain={currentWeek.cookDays[1].chainTo} note={currentWeek.cookDays[1].leftoverNote} />
            ...
            <LeftoverDay day="Saturday" meal={leftoverMsgs.sat} visible={leftovers && enabledMeals.Fri && coversNextNight(currentWeek.cookDays[2])} chain={currentWeek.cookDays[2].chainTo} note={currentWeek.cookDays[2].leftoverNote} />
