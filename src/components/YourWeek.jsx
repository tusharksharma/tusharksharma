...
const WEEKS = {
  ...
  2: {
    ...
    cookDays: [
      { day: "Monday", label: "Steak Night", vibe: "Bavette + chimichurri + air fryer fries — start strong with a low-carb showstopper", id: 25, time: "20 min", reheats: false, leftoverNote: "Slice the cold steak into a steak salad — don't microwave it. The chimichurri keeps 3-4 days.", adult: "Bavette steak, chimichurri, fries", kid: "Pork patties, fries, carrots", needs: ["Bavette", "Fries", "Spiceology Chimichurri", "Pork patties"], carbLevel: "low" },
  ...
  3: {
    label: "Week 3",
    description: "Different style every night. The gnocchi reheats but won't re-crisp — that's the tradeoff.",
    subtitle: "Gnocchi, Chicken Sandwiches, Golden Rice Bowl",
    cookDays: [
      { day: "Monday", label: "Comfort + Protein", vibe: "Crispy gnocchi, creamy sauce — comfort that earns its calories", id: 1, time: "30 min", reheats: false, leftoverNote: "Microwave 90 sec with a splash of milk to loosen the sauce. The gnocchi won't re-crisp — that's the tradeoff.", adult: "Spicy fajita cream, peppers, chili oil", kid: "Rao's Alfredo or mild creamy", needs: ["Chicken", "Gnocchi", "Bell peppers", "Cottage cheese", "Dan-O's"], carbLevel: "high" },
  ...
  4: {
    ...
    cookDays: [
      { day: "Monday", label: "Steak Night", vibe: "Start strong — bavette + chimichurri + air fryer fries", id: 25, time: "20 min", reheats: false, leftoverNote: "Slice the cold steak into a steak salad — don't microwave it. The chimichurri keeps 3-4 days.", adult: "Bavette steak, chimichurri, fries", kid: "Pork patties, fries, carrots", needs: ["Bavette", "Fries", "Spiceology Chimichurri", "Pork patties"], carbLevel: "low" },
      { day: "Wednesday", label: "Smash Night", vibe: "15 min — crispy smash tacos, Caesar finish", id: 22, time: "15 min", reheats: true, adult: "Keto tortilla, Caesar, crushed Quest chips", kid: "Street taco tortilla, simple taco, chips on side", needs: ["Ground chicken", "Cheddar", "Keto tortillas", "Romaine", "Caesar dressing"], carbLevel: "low" },
  ...
  5: {
    ...
    cookDays: [
      { day: "Monday", label: "Grill Night", vibe: "Tandoori drumsticks — marinated overnight, grilled in 30 min", id: 26, time: "30 min", reheats: true, adult: "3 tandoori drumsticks, spicy onions, cucumber", kid: "Mild drumstick (1/6 the masala), cucumber, naan", needs: ["Drumsticks", "Greek yogurt", "Shan Tandoori Masala", "Lemon", "Naan"], carbLevel: "none" },
  ...
  7: {
    ...
    cookDays: [
      { day: "Monday", label: "Ramen Night", vibe: "61g protein ramen in 15 min — Buldak for adults, Maruchan for kids", id: 29, time: "15 min", reheats: false, repeatCook: true, leftoverNote: "Cook the ramen again — it's a 15-minute build from scratch and the recipe says to make it fresh each time.", adult: "Spicy Buldak in bone broth, semi-dry, sausage", kid: "Maruchan chicken ramen + sausage", needs: ["Buldak ramen", "Maruchan", "Bilinski's sausage", "Bone broth"], carbLevel: "high" },
  ...
  9: {
    ...
    cookDays: [
      ...
      { day: "Wednesday", label: "Steak Night", vibe: "Bavette + chimichurri + air fryer fries — midweek showstopper", id: 25, time: "20 min", reheats: false, leftoverNote: "Slice the cold steak into a steak salad — don't microwave it. The chimichurri keeps 3-4 days.", adult: "Bavette steak, chimichurri, fries", kid: "Pork patties, fries, carrots", needs: ["Bavette", "Fries", "Spiceology Chimichurri", "Pork patties"], carbLevel: "low" },
  ...
  18: {
    ...
    cookDays: [
      { day: "Monday", label: "Burger Night", vibe: "30 min — one griddle, two beef grades (93/7 adult double, 80/20 kid slider). Bettergoods keto bun + In-N-Out-style spread with harissa for adults; Marketside brioche slider + bottled sauce + ketchup for kids. 490 cal / 51g protein adult plate.", id: 47, time: "30 min", reheats: false, repeatCook: true, leftoverNote: "Smash a second round — the crust turns to leather in the fridge, so these are always cooked fresh.", adult: "Keto bun + 2x 93/7 smash patties + Velveeta + spread-with-harissa + Rally's fries", kid: "Brioche slider + 1x 80/20 patty + Velveeta + bottled sauce + 1/2 fries + ketchup", needs: ["93/7 ground beef (12 oz)", "80/20 ground beef (6 oz)", "Bettergoods Keto Friendly Hamburger Buns (2)", "Marketside Brioche Slider Rolls (2)", "Velveeta Original slices (6)", "Rally's Famous Fries (3 servings)", "Yellow mustard", "Light mayo", "Ketchup", "Pickle juice", "Harissa (Shuug or any)", "Dill pickles", "Bottled secret sauce (Heinz Special or similar)", "Kosher salt", "Cooking spray"], carbLevel: "medium" },
      { day: "Wednesday", label: "Pizza Night", vibe: "Adults: 1/3 Bettergoods Margherita + Caesar Crunch Salad. Kids: personal Red Baron Deep Dish + small salad. Different pizzas, no slice-fairness fights.", id: 40, time: "20 min", reheats: true, adult: "1/3 Bettergoods Margherita + Caesar Crunch Salad with Dan-O's Jalapeño Cheesoning + optional Chipotle Crema", kid: "1 personal Red Baron Deep Dish (Pepperoni or Four Cheese) + small Caesar Crunch portion", needs: ["Soules Kitchen Fajita Chicken (2 pouches)", "Bettergoods Italian Wood-Fired Margherita Pizza", "Red Baron Deep Dish Singles (Pepperoni or Four Cheese, 2)", "Tanimura & Antle Sweet Gem", "Bolthouse Farms Creamy Caesar Parmigiano", "Quest Hot & Spicy Protein Chips", "Dan-O's Jalapeño Cheesoning", "Smoky Chipotle Crema (optional cookbook)"], carbLevel: "high" },
  ...
  22: {
    ...
    cookDays: [
      ...
      { day: "Wednesday", label: "Grill Night", vibe: "Tandoori drumsticks — marinated overnight, grilled in 30 min", id: 26, time: "30 min", reheats: true, adult: "3 tandoori drumsticks, spicy onions, cucumber", kid: "Mild drumstick (1/6 the masala), cucumber, naan", needs: ["Drumsticks", "Greek yogurt", "Shan Tandoori Masala", "Lemon", "Naan"], carbLevel: "none" },
  ...
  34: {
    batchMultiplier: 2,
    label: "Week 34",
    description: "High-Protein Pepperoni Mac Meal Prep Week — boxed mac and cheese, made to work harder with three simple swaps. Monday: cook a double batch of Annie's Super Mac shells, whisk the cheese packets into whole milk, fold in the shells, then chop and fold in turkey pepperoni. Portion into full and smaller servings across the week — same creamy pepperoni mac for everyone, no separate kid meal and no butter. Wednesday reheats the reserved portions with a splash of milk. Friday steak-and-fries. Full serving: about 370 cal / 25g protein; child portions sized to appetite and intentionally not published. This week runs a DOUBLE batch — the grocery quantities below are already doubled — so the batch covers every night through Saturday.",
    subtitle: "Pepperoni Mac Batch + Wed Reheat + Steak Night",
    cookDays: [
      { day: "Monday", reheats: true, label: "Pepperoni Mac Batch Cook", vibe: "20 min — this week is a double batch (the grocery amounts below are already doubled). Cook and drain the shells from all the boxes per the package. Whisk every cheese packet into whole milk (1 cup per 3 boxes) until smooth — no butter. Fold the shells into the sauce, then chop the turkey pepperoni and fold it through evenly. Portion into full servings for the adults and smaller servings sized to the kids' appetites. Each 3-box batch is two family dinners for 2A+2K, so the double batch = four dinners: half feeds tonight + Tuesday, half holds for Wednesday + Thursday. Refrigerate the portions in airtight containers.", id: 65, time: "20 min", fixedBatch: true, batchCoversDays: ["Mon", "Wed"], adult: "One full serving of creamy pepperoni mac (creator est. ~370 cal / 25g protein)", kid: "One smaller serving — same mac, portioned to appetite (Tushar's build; kid macros not published)", needs: ["Annie's Super Mac Shells & White Cheddar (6 boxes — higher-protein line)", "Whole milk (2 cups — creator used Nurri)", "Turkey pepperoni (8 servings, chopped)", "Avocado-oil spray (optional — only if the pot needs it)"], carbLevel: "high" },
      { day: "Wednesday", reheats: true, label: "Pepperoni Mac Reheat", vibe: "5 min — pull the reserved portions from Monday's double batch (the Wednesday + Thursday half). Microwave each portion 60-90 sec until steaming, stirring once; add a splash of milk if it tightened up in the fridge. Same full and smaller servings as Monday. Thursday repeats from the same reserved half.", id: 65, time: "5 min", isReheat: true, reheatOf: "Mon", adult: "Reheated full serving + a splash of milk (creator est. ~370 cal / 25g protein)", kid: "Reheated smaller serving (Tushar's build; adjust to appetite)", needs: [], carbLevel: "high" },
      { day: "Friday", label: "Steak Night", vibe: "20 min — Checkers/Rally's frozen fries in the air fryer first (12-15 min), bavette steak seared 2-3 min per side in a hot stainless pan while fries finish, pork breakfast patties cooked in the same pan during the 5-min steak rest. No-judge chimichurri = Spiceology Chimichurri Blend + olive oil + red wine vinegar + chili flakes (mix, sit 5 min). Adults get sliced bavette + fries + chimichurri; kids get cut-up pork patties + fries + raw carrots. ~45g protein / 620 cal per adult. Cross-link to No-Judge Chimichurri cookbook entry.", id: 25, time: "20 min", reheats: false, leftoverNote: "Slice the cold steak into a steak salad — don't microwave it. The chimichurri keeps 3-4 days.", adult: "Sliced bavette + Checkers fries + spoonful of chimichurri over the steak", kid: "Cut-up pork breakfast patties + fries + raw carrots (no sauce)", needs: ["Bavette steak (6 oz per adult)", "SPG seasoning (salt, pepper, garlic)", "Great Value pork breakfast patties (kid, 1.5 per kid)", "Checkers/Rally's frozen fries", "Spiceology Chimichurri Blend", "O California organic extra virgin olive oil", "Napa Valley Naturals organic red wine vinegar", "Chili flakes", "Raw carrots (baby or sticks, kid)", "Cooking spray"], carbLevel: "low", chainTo: { slug: "no-judge-chimichurri", title: "No-Judge Chimichurri", note: "The 60-second sauce that carries this dinner — Spiceology blend + olive oil + red wine vinegar + a rest." } },
    ],
  },
};

// A cook day covers the following night when the dish plain-reheats, or when
// it carries an authored second-night plan for a dish that doesn't. Target
// shape is 3 dinners covering 6 nights, with Sunday free.
const coversNextNight = (d) => Boolean(d && (d.reheats || d.leftoverNote || d.repeatCook));

// Both a reheat day and a repeatCook day need double the ingredients: one
// cooks a double batch, the other cooks the same dish twice. Same shopping
// list either way, so they share the grocery multiplier.
const needsDoubleGroceries = (d) => Boolean(d && (d.reheats || d.repeatCook));
...
function LeftoverDay({ day, meal, visible, chain, note, repeat }) {
  if (!visible) return null;
  // An authored note is the second-night plan for a dish that does NOT plain
  // reheat — it quotes that recipe's own storage guidance. It wins over
  // chainTo, which is usually a component cross-link (a sauce, a rice base)
  // and reads as nonsense in a dinner slot: "Saturday: Reinvent as No-Judge
      ...
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="relative" id="timeline">
          ...
          <div className="space-y-2 relative">
            ...
            <LeftoverDay day="Tuesday" meal={leftoverMsgs.tue} visible={leftovers && enabledMeals.Mon && coversNextNight(currentWeek.cookDays[0])} chain={currentWeek.cookDays[0].chainTo} note={currentWeek.cookDays[0].leftoverNote} repeat={currentWeek.cookDays[0].repeatCook} />
            ...
            <LeftoverDay day="Thursday" meal={leftoverMsgs.thu} visible={leftovers && enabledMeals.Wed && coversNextNight(currentWeek.cookDays[1])} chain={currentWeek.cookDays[1].chainTo} note={currentWeek.cookDays[1].leftoverNote} repeat={currentWeek.cookDays[1].repeatCook} />
            ...
            <LeftoverDay day="Saturday" meal={leftoverMsgs.sat} visible={leftovers && enabledMeals.Fri && coversNextNight(currentWeek.cookDays[2])} chain={currentWeek.cookDays[2].chainTo} note={currentWeek.cookDays[2].leftoverNote} repeat={currentWeek.cookDays[2].repeatCook} />
        ...
        {(() => {
          ...
          const legacyLeftoverDays = leftovers ? currentWeek.cookDays.filter((d, i) => enabledMeals[dayKeys[i]] && coversNextNight(d)).length : 0;
          ...
          currentWeek.cookDays.forEach((day, i) => {
            ...
            if (leftovers && needsDoubleGroceries(day)) mealProtein *= 2;
